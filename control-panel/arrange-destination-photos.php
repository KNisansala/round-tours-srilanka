            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Destination photos</h2>
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/destination-photo.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count(DESTINATION_PHOTO) > 0) {
                                                        foreach (DESTINATION_PHOTO as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/destination/gallery/thumb/<?php echo $img["image_name"]; ?>" alt=""/>
