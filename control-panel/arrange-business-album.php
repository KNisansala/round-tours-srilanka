...
$BUSINESS_ALBUM = new PhotoAlbum(NULL);
?>
<!DOCTYPE html>
<html> 
    <head>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/photo-album.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($PHOTO_ALBUM->all()) > 0) {
                                                        foreach ($PHOTO_ALBUM->all() as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/photo-album/<?php echo $img["image_name"]; ?>" alt=""/>
