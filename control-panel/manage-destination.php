                                            ...
                                            foreach ($DESTINATION as $key => $destination) {
                                                ...
                                                <div class="col-md-3"  id="div<?php echo $destination['id']; ?>">
                                                    <div class="photo-img-container">
                                                        <img src="../upload/destination/<?php echo $destination['image_name']; ?>" class="img-responsive ">
                                                    </div>
                                                    <div class="img-caption">
                                                        <p class="maxlinetitle"><?php echo $destination['title']; ?></p>
                                                        <div class="d">
                                                            <a href="#"  class="delete-attraction" data-id="<?php echo $destination['id']; ?>"> <button class="glyphicon glyphicon-trash delete-btn"></button></a>
                                                            ...
                                                            <a href="view-destination-photos.php?id=<?php echo $destination['id']; ?>">  <button class="glyphicon glyphicon-picture arrange-btn"></button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php
