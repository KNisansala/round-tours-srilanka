                                ...
                                <form class="form-horizontal" method="post" action="post-and-get/destination.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="title" class="form-control"  value="<?php echo $DESTINATION->title; ?>"  name="title"  required="TRUE">
                                    ...
                                    <div class="col-md-12">                                       
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <img src="../upload/attraction/<?php echo $DESTINATION->image_name; ?>" id="image" class="view-edit-img img img-responsive img-thumbnail" name="image" alt="old image">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="short_description" class="form-control" value="<?php echo $DESTINATION->short_description; ?>"  name="short_description">
