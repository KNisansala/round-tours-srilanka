...
$COUNT_DESTINATION = count(Destination::all());
...
<html> 
    ...
    <!--                                    <small>  </small>-->
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <div class="number count-to" data-from="0" data-to=" <?php echo $COUNT_DESTINATION ; ?>" data-speed="1500" data-fresh-interval="1"></div>
                                </ul>
                            </div>
                            <div class="body">
                                <div class="list-group">
